...
// Navbar background change on scroll - Updated for space theme
window.addEventListener('scroll', () => {
    const navbar = document.querySelector('.navbar');
    if (window.scrollY > 100) {
        navbar.style.background = 'rgba(15, 15, 35, 0.98)';
        navbar.style.boxShadow = '0 2px 20px rgba(138, 43, 226, 0.2)';
    } else {
...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        // The form will be handled by the action URL
...
function showNotification(message, type = 'info') {
    ...
    notification.style.cssText = `
        ...
        top: 100px;
        right: 20px;
        background: ${type === 'success' ? '#00d4ff' : type === 'error' ? '#ff6b6b' : '#8a2be2'};
        color: white;
        padding: 1rem 1.5rem;
        border-radius: 12px;
...
// Add CSS for notifications and active nav links
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    scrollToTopBtn.addEventListener('mouseenter', () => {
        ...
        scrollToTopBtn.style.boxShadow = '0 6px 20px rgba(138, 43, 226, 0.4)';
    });
    
    scrollToTopBtn.addEventListener('mouseleave', () => {
        scrollToTopBtn.style.transform = 'translateY(0)';
        scrollToTopBtn.style.boxShadow = '0 4px 12px rgba(138, 43, 226, 0.3)';
    });
});
